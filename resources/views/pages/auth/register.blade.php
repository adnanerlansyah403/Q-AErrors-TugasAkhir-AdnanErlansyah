            ...
            <div class="flex items-center gap-10 flex-wrap">
                ...
                <div class="mb-10 w-[48%]">
                    ...
                    <div class="relative shadow-[rgba(60,_64,_67,_0.3)_0px_1px_2px_0px,_rgba(60,_64,_67,_0.15)_0px_2px_6px_2px] p-4 rounded-lg active:border border-red-primary transition duration-200">
                        <input type="file" name="photo" id="photo" value="{{ old('photo') }}" x-ref="photo" class="pointer-events-none" placeholder="Your photo..." >
                        <span x-on:click="
                        $refs.photo.click();
                        $refs.photo.content = $refs.photo.files[0]
                        " class="absolute cursor-pointer text-center flex items-center justify-center right-0 top-0 bottom-0 bg-red-primary text-white w-32 rounded-lg hover:text-slate-800">
                            Upload
                        </span>
                    </div>
                </div>
