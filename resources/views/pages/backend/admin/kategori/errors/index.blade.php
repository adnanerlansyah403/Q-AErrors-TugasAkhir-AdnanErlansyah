...
<div class="mt-4 mx-6">
    <h3 class="mt-10" class="text-blue-800 font-bold dark:text-white">Admin / Kategori / Errors </h3>
    <h1 class="text-blue-800 text-lg font-bold mt-2 dark:text-white">Kategori Errors</h1>
          ...
          <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            ...
            @forelse ($categories as $category)
              <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">{{ $category->description ? $category->description : "Tidak ada deskripsi" }}</td>
                <td class="px-4 py-3 flex items-center gap-2">
                  <a href="{{ route("admin.kategori.errors.edit", $category) }}" class="text-white bg-yellow-400 p-2 rounded-lg">
                  ...
                  <a href="{{ route("admin.kategori.errors.destroy", $category) }}" class="text-white bg-red-600 p-2 rounded-lg cursor-pointer">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
