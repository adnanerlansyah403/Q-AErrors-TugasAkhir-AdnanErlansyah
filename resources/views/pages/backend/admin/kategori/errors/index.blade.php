...
<div class="mt-4 mx-6">
    <h3 class="mt-10"><span class="text-blue-800 font-bold dark:text-white">Admin</span> / Kategori / Errors </h3>
    <h1 class="text-blue-800 text-4xl font-bold mt-2 dark:text-white">Kategori Errors</h1>
          ...
          <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
              ...
              <td class="px-4 py-3 flex items-center gap-2">
                <a href="{{ route("admin.kategori.errors.edit") }}" class="text-white bg-yellow-400 p-2 rounded-lg">
