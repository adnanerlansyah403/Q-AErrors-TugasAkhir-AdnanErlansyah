...
<div class="mt-4 mx-4">
    <h3 class="mt-10"><span class="text-blue-800 dark:text-white font-bold">Admin</span> / List </h3>
    <h1 class="text-blue-800 dark:text-white text-lg font-bold mt-2">Admin List</h1>
                ...
                <td class="px-4 py-3">
                  <div class="flex items-center text-sm">
                    <div>
                      ...
                      <p class="text-xs text-gray-600 dark:text-gray-400">{{ $a->profession }}</p>
                    </div>
                  </div>
                </td>
                <td class="px-4 py-3 text-sm">{{ $a->email }}</td>
                <td class="px-4 py-3 text-sm">{{ $a->birthdate ? $a->birthdate : "Data Kosong" }}</td>
                <td class="px-4 py-3 text-xs">
                  {{ $a->gender == 'l' ? "Laki-Laki" : "Perempuan" }}
                </td>
                <td class="px-4 py-3 flex items-center gap-2">
                  <a href="{{ route("admin.list.show", $a->id) }}" class="text-white bg-blue-800 p-2 rounded-lg">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12 4.5C7 4.5 2.73 7.61 1 12C2.73 16.39 7 19.5 12 19.5C17 19.5 21.27 16.39 23 12C21.27 7.61 17 4.5 12 4.5ZM12 17C9.24 17 7 14.76 7 12C7 9.24 9.24 7 12 7C14.76 7 17 9.24 17 12C17 14.76 14.76 17 12 17ZM12 9C10.34 9 9 10.34 9 12C9 13.66 10.34 15 12 15C13.66 15 15 13.66 15 12C15 10.34 13.66 9 12 9Z" fill="currentColor"/>
                        </svg>                      
                  </a>
                  <a href="{{ route("admin.list.destroy", $a->id) }}" class="text-white bg-red-600 p-2 rounded-lg">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
