...
<section class="section">
    <div class="container">
        ...
        <div class="w-full mt-6 flex flex-wrap items-center gap-6">
            ...
            <form method="POST" action="{{ route("users.myquestion.update", $question) }}" class="card-item gap-6 px-6 py-6 rounded-lg shadow-[rgba(60,_64,_67,_0.3)_0px_1px_2px_0px,_rgba(60,_64,_67,_0.15)_0px_1px_3px_1px] w-full">
                @csrf
